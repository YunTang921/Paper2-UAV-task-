# 作用: 读取配置并构建已训练的 HetNet/PtrNet 推理模型;
# 依赖: rl_mission_planning.py、solver.py; 被依赖: baseline_analyze.py 等评估脚本
import argparse
import json
...
if __name__ == "__main__":
    input_model = load_model_eval('Models/PtrNet/PtrNet_C4_V4_D4.param', 'Models/PtrNet/PtrNet_C4_V4_D4.config')
